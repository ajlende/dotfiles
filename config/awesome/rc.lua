...
-- beautiful.init("/home/ajlende/.config/awesome/themes/monochrome-theme.lua")
beautiful.init("/usr/share/awesome/themes/default/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "terminator"
wwwbrowser = "chromium"
filebrowser = "pcmanfm --daemon-mode"
musicplayer = terminal .. " -e ncmpcpp"
volumes = terminal .. " -e alsamixer"
equalizer = terminal .. " -e alsamixer -D equal"
screenshot = "scrot"
info = terminal .. " -e screenfetch"
imageeditor = "gimp"
vectoreditor = "incscape"
videoplayer = "vlc"
guieditor = "gvim"
screenlock = "slimlock"
...
myawesomemenu = {
  ...
  { "edit config", guieditor .. " " .. awesome.conffile },
...
mytextclock = awful.widget.textclock.new("%a %b %d, %I:%M", 60)
