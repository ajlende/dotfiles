" Base16 Base16 NGEva (https://github.com/chriskempson/base16)
" Scheme: Alex Lende ajlende@gmail.com
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-base16-ngeva.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-base16-ngeva"
